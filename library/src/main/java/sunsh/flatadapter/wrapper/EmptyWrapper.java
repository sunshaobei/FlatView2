...
public class EmptyWrapper<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        if (isEmpty())
        {
            ...
            if (mEmptyView != null)
            {
                holder = FlatViewHolder.Companion.createViewHolder(parent.getContext(), mEmptyView);
            } else
            {
                holder = FlatViewHolder.Companion.createViewHolder(parent.getContext(), parent, mEmptyLayoutId);
            }
            return holder;
        }
